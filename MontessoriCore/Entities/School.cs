...
namespace Montessori.Core
{
    ...
    {
        private int _id = -1;
        private string _schoolName = "NATIONAL PEACE KIDS ZONE";
        private string _shortName = "NPKZ";
        ...
        private string _slogan = "Affiliated to National Peace Secondary Boarding School";
