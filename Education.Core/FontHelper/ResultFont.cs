...
namespace Education.Common.FontHelper
{
    public class ResultFont
    {
        ...
        public Font LedgerSubject { get; private set; }
        ...
        public ResultFont(App app)
        {
            ...
            if (app == App.NPSBS)
            {
                SchoolName = new Font(Bernard, 12, Font.NORMAL, BaseColor.BLACK);
                SchoolAddress = new Font(TimesBold, 11, Font.NORMAL, BaseColor.BLACK);
                ...
                Bold = new Font(TimesBold, 12, Font.NORMAL, BaseColor.BLACK);
                LedgerSubject = new Font(TimesNormal, 10, Font.NORMAL, BaseColor.BLACK);
            }
            else
            {
