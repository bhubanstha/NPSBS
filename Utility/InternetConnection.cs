        ...
        public static About GetAbout()
        {
            ...
            if (InternetConnection.InInternetConnected())
            {
                using (var client = new WebClient())
                {
                    ...
                    Uri uri = new Uri("https://api.jsonbin.io/b/5b516f9d4d5ea95c8ba76abc/4");
                    ...
                    about.SchoolSoftwareAbout = about.SchoolSoftwareAbout
                        ...
                        .Replace("*ShortName*", "SN")
                        .Replace("*SchoolName*", "Short Name School")
                        .Replace("*Address*", "Balaju, Kathmandu, Nepal");
                    return about;
                }
            }
            return about;
